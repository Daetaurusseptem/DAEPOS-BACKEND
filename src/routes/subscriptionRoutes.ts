...
import { obtenerProductos, obtenerPreciosDeProducto, createCheckoutSession, obtenerFacturasEmpresa, createCustomerPortalSession } from '../controllers/subscriptionsController';
...
router.post('/portal', [
    verifyToken,
    validarRol('companyAdmin', 'sysadmin')
